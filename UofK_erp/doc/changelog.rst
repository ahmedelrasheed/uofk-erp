...
- Added new backend theme for UofK. `Enterprise`
...
`8.0.0`
-------
- UofK Now compatible with Odoo v8.
- Added demo portal
...
- Added Annoucement Bar on the top to keep users updated with latest news about UofK
- minor bug fixes
