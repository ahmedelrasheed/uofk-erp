...
class OpAdmission(models.Model):
    ...
    def get_student_vals(self):
        enable_create_student_user=self.env['ir.config_parameter'].get_param('uofk_admission.enable_create_student_user')
        for student in self:
            student_user=False
    ...
    def open_student(self):
        form_view = self.env.ref('uofk_core.view_op_student_form')
        tree_view = self.env.ref('uofk_core.view_op_student_tree')
        value = {
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/uofk_admission/static/xls/op_admission.xls'
        }]
...
class ResConfigSettings(models.TransientModel):
    ...
    enable_create_student_user = fields.Boolean(config_parameter='uofk_admission.enable_create_student_user',
